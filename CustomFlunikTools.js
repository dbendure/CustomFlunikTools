...
// @description Tiberium Alliances Auto Leveling Only
// @version     0.5.9
							...
							for (var nCity in ClientLib.Data.MainData.GetInstance().get_Cities().get_AllCities().d) {
								...
								for (var nBuildings in buildings.d) {
									...
									if (window.FlunikTools.Main.getInstance().buildingsToUpdate.indexOf(name) != -1) {
										...
										//if (Math.random() > 0.90) {
										if (
										(name == "Harvester" || name == "Power Plant" || name == "Refinery") && (baselvl > buildinglvl && powCost < 400000)) {
											console.log(building);
											ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", building_obj, null, null, true);
										}
										if (
										(name == "Accumulator" && powCost < 1000000) || (name == "Silo" && powCost > 1000000 && baselvl + 5 > buildinglvl)) {
											console.log(building);
											ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", building_obj, null, null, true);
										}
										if (
										(name == "Barracks" && airRT < infRT) || (name == "Factory" && airRT < vehRT) || (name == "Airfield" && airRT > vehRT) || (name == "Defense Facility" && baselvl < buildinglvl) && (powCost < 1300000)) {
											console.log(building);
											ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", building_obj, null, null, true);
										}
										if (
										(
										name == "Command Center" || name == "Construction Yard" || name == "Defense HQ") && (baselvl > buildinglvl)) {
 
											console.log(building);
											ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", building_obj, null, null, true);
										}
										if (
										(name == "Falcon Support" || name == "Ion Cannon Support" || name == "Skystrike Support") && (baselvl > buildinglvl && powCost < 300000)) {
