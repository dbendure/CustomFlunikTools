                            ...
                            for (var nCity in ClientLib.Data.MainData.GetInstance().get_Cities().get_AllCities().d) {
                                ...
                                for (var nBuildings in buildings.d) {
                                    ...
                                    **************************************************************************************************************************************************************************************************************************************************************************************************************************************							  
                                    ...
                                    if ((tech == ClientLib.Base.ETechName.PowerPlant) && (building.get_CurrentLevel() > 2) && (((powPacGain * _this.z) > (cryPacGain * _this.y)) && ((powPacGain * _this.z) > (tibPacGain * _this.y))) && (_this.p == 1)) {
                                        var pow = building;
                                        pownum++;
                                        //var refObj = Object();CreditsBonusTimeToComplete
                                    ...
                                    if ((tech == ClientLib.Base.ETechName.Harvester && building.get_CurrentLevel() > 2) && ((powPacGain * _this.z) < (tibPacGain * _this.y)) && ((powPacGain * _this.z) < (cryPacGain * _this.y)) && (_this.h == 1)) {
                                        var harv = building;
                                        harnum++;
                                        harnum1++;
                                        ...
                                        if ((city.GetBuildingCache(bulid).DetailViewInfo.OwnProdModifiers.d[1, 25, 33])) { //console.log(city.GetBuildingCache(bulid).DetailViewInfo.OwnProdModifiers.d[1,25,33]);&& (powPacGain > tibPacGain)&& (powPacGain > cryPacGain)
                                        ...
                                        if ((city.GetBuildingCache(bulid).DetailViewInfo.OwnProdModifiers.d[4, 26, 34]) && (cryPacGain <= tibPacGain)) {
                                    ...
                                    if ((tech == ClientLib.Base.ETechName.Accumulator) && (building.get_CurrentLevel() > 2) && (((powPacGain) > (powContGain))) && (_this.a == 1)) {
                                        var acc = building;
                                        accnum++;
                                        //var refObj = Object();CreditsBonusTimeToComplete
                                    ...
                                    if ((tech == ClientLib.Base.ETechName.Silo) && (building.get_CurrentLevel() > 2) && (((cryPacGain) > (cryContGain)) && ((tibPacGain) > (tibContGain))) && (_this.s == 1)) {
                                        var silo = building;
                                        silnum++;
...
**************************************************************************************************************************************************************************************************************************************************************************************************************************************							  
	*/ // console.log(baseName,refnum,pownum);
                                ...
                                if ((Ref_obj != undefined) && (refarr.toString() != "") && (maxarr[0] == refarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < 14400) && (_this.x == 0)) || (_this.x == 1)) && (refnum > pownum)) { /*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||( building.get_CurrentLevel() > 2)*/
                                ...
                                if ((Pow_obj != undefined) && (powarr.toString() != "") && (maxarr[0] == powarr[0]) && (((_this.totalRepairTime(airRT, vehRT, infRT) < 14400) && (_this.x == 0)) || (_this.x == 1)) && (refnum < pownum)) { /*(_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||*/
