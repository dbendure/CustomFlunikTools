...
/*The Building Function*/BuildingautoUpgrade : function() {
                            ...
                            var baselvl = city.get_LvlBase();
                             ...
                             for (var nBuildings in buildings.d) {
                                 ...
                                 if (	(tech == ClientLib.Base.ETechName.Construction_Yard|| tech ==ClientLib.Base.ETechName.Command_Center || tech ==ClientLib.Base.ETechName.Defense_HQ ) && (building.get_CurrentLevel() < blvlLow) && (_this.totalRepairTime(airRT, vehRT, infRT) < 14400)	){
								  ...
								  if (	(tech == ClientLib.Base.ETechName.Defense_Facility) && (_this.totalRepairTime(airRT, vehRT, infRT) < 14400)	){
                ...
                console.log(Ref_obj, refarr);console.log(Pow_obj, powarr);console.log(Har_obj, hararr); console.log(Har1_obj, hararr1);console.log(Acc_obj, accarr);console.log(Sil_obj, silarr);
							...
							*/
							  ...
							  if((building_obj != undefined) && ((_this.totalRepairTime(airRT, vehRT, infRT) < 14400)||(building_obj.buildinglevel < 15))){
							  console.log(building_obj);
							  ClientLib.Net.CommunicationManager.GetInstance().SendCommand("UpgradeBuilding", building_obj, null, null, true);
							  building_obj = {};
							  break;
